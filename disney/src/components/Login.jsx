...
const Login = () => {
	...
	return (
		<div className="flex flex-col items-center justify-center h-screen bg-gray-800">
			<img src={logo} className="w-[150px] mb-10" alt="Disney+" />
			<div className="bg-white rounded-xl shadow-md p-10 w-full md:w-1/2 max-w-md">
				...
				<form onSubmit={handleLogin}>
					...
					<div className="mb-5">
						<label htmlFor="email" className="text-sm block font-medium text-gray-700">Email</label>
						<input
							type="email"
							id="email"
							value={email}
					...
					<div className="mb-5">
						<label htmlFor="password" className="text-sm block font-medium text-gray-700">Password</label>
						<input
							type="password"
							id="password"
							value={password}
					...
					<button type="submit" className="bg-blue-600 text-white w-full  px-5 py-2 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
						Login
					</button>
